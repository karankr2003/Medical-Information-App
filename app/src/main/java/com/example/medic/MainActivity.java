...
public class MainActivity extends AppCompatActivity {
    EditText medicineName, medicineDate,medicineDist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicineDist = findViewById(R.id.distributer);
        ...
        swtch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (!isChecked) {
                    ...
                    medicineDist.setVisibility(View.VISIBLE);
                } else {
        ...
        insertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String distt= medicineDist.getText().toString();
        ...
        fetchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                do {
                    ...
                    dist= dist + (String.valueOf(cu.getString(cu.getColumnIndex("medicineDist"))));
                    med += "\n";
                } while (cu.moveToNext());
